...
const ProductCard = ({ id, name, price, image, rating = 4.8 }) => {
  return (
    <Link to={`/products/${id}`}>
      <div className="group rounded-2xl border border-zinc-800 bg-zinc-950 p-3 transition-all duration-300 hover:-translate-y-1 hover:border-orange-500">
        {/* Top */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="rounded-lg border border-orange-500 p-2 text-orange-500 transition-all duration-300 group-hover:bg-orange-500 group-hover:text-white">
